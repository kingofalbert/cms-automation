...
gcloud run deploy cms-automation-backend \
  ...
  --set-env-vars="ENVIRONMENT=production,GCP_PROJECT_ID=cmsupload-476323,LOG_LEVEL=INFO,GOOGLE_DRIVE_FOLDER_ID=1r4YwLr-58AvVl3e7TW5zqWn0X95-3EcG,DATABASE_POOL_SIZE=3,DATABASE_MAX_OVERFLOW=2,DATABASE_POOL_RECYCLE=270"
```
