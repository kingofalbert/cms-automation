...
gcloud run deploy "${SERVICE}" \
  ...
  --set-env-vars="ENVIRONMENT=production,GCP_PROJECT_ID=${PROJECT},LOG_LEVEL=INFO,GOOGLE_DRIVE_FOLDER_ID=1r4YwLr-58AvVl3e7TW5zqWn0X95-3EcG,DATABASE_POOL_SIZE=5,DATABASE_MAX_OVERFLOW=5,DATABASE_POOL_RECYCLE=270"
