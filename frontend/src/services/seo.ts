...
export const seoAPI = {
  ...
  get: (articleId: number) =>
    api.get<APIResponse<SEOMetadata>>(`/v1/seo/articles/${articleId}`),
  ...
  update: (articleId: number, data: SEOUpdateRequest) =>
    api.put<APIResponse<SEOMetadata>>(`/v1/seo/articles/${articleId}`, data),

  /**
   * Delete SEO metadata for an article.
   */
  delete: (articleId: number) =>
    api.delete<APIResponse<void>>(`/v1/seo/articles/${articleId}`),
